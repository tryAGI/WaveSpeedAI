...
The WaveSpeedAI SDK provides `AIFunction` tool wrappers compatible with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai). These tools can be used with any `IChatClient` to give AI models access to WaveSpeed AI's image and video generation from 700+ models, task result polling, and prediction history.
