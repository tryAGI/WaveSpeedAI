...
{
    /// <inheritdoc />
    public sealed class ImageGenerationRequestOutputFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WaveSpeedAI.ImageGenerationRequestOutputFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::WaveSpeedAI.ImageGenerationRequestOutputFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
