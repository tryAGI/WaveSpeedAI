...
{
    /// <inheritdoc />
    public sealed class ListPredictionsRequestStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WaveSpeedAI.ListPredictionsRequestStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::WaveSpeedAI.ListPredictionsRequestStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
