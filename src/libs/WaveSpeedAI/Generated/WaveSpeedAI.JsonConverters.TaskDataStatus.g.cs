...
{
    /// <inheritdoc />
    public sealed class TaskDataStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WaveSpeedAI.TaskDataStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::WaveSpeedAI.TaskDataStatusExtensions.ToValueString(value));
        }
    }
}
