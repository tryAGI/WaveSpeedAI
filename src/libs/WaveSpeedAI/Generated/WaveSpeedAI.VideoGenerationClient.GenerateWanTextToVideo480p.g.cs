...
namespace WaveSpeedAI
{
    public partial class VideoGenerationClient
    {
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement s_GenerateWanTextToVideo480pSecurityRequirement0 =
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement[] s_GenerateWanTextToVideo480pSecurityRequirements =
            new global::WaveSpeedAI.EndPointSecurityRequirement[]
            {                s_GenerateWanTextToVideo480pSecurityRequirement0,
            };
        partial void PrepareGenerateWanTextToVideo480pArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::WaveSpeedAI.VideoGenerationRequest request);
        partial void PrepareGenerateWanTextToVideo480pRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::WaveSpeedAI.VideoGenerationRequest request);
        partial void ProcessGenerateWanTextToVideo480pResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateWanTextToVideo480pResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.TaskResponse> GenerateWanTextToVideo480pAsync(

            global::WaveSpeedAI.VideoGenerationRequest request,
            global::WaveSpeedAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateWanTextToVideo480pAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateWanTextToVideo480pAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateWanTextToVideo480pArguments(
            ...
            var __authorizations = global::WaveSpeedAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateWanTextToVideo480pSecurityRequirements,
                operationName: "GenerateWanTextToVideo480pAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::WaveSpeedAI.PathBuilder(
                                path: "/wavespeed-ai/wan-2.1/wan-2.1-t2v-480p",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateWanTextToVideo480pRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::WaveSpeedAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateWanTextToVideo480p",
                                methodName: "GenerateWanTextToVideo480pAsync",
                                pathTemplate: "\"/wavespeed-ai/wan-2.1/wan-2.1-t2v-480p\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateWanTextToVideo480pResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::WaveSpeedAI.ApiException.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateWanTextToVideo480pResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateWanTextToVideo480pAsync(
                request: __request,
                requestOptions: requestOptions,
