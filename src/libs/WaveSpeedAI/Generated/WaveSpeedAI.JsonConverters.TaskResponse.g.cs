...
{
    /// <inheritdoc />
    public class TaskResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WaveSpeedAI.TaskResponse>
    {
        /// <inheritdoc />
        public override global::WaveSpeedAI.TaskResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("data.error")) __score1++;
            if (__jsonProps.Contains("data.has_nsfw_contents")) __score1++;
            if (__jsonProps.Contains("data.id")) __score1++;
            if (__jsonProps.Contains("data.model")) __score1++;
            if (__jsonProps.Contains("data.outputs")) __score1++;
            if (__jsonProps.Contains("data.status")) __score1++;
            if (__jsonProps.Contains("data.timings")) __score1++;
            if (__jsonProps.Contains("data.urls")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::WaveSpeedAI.TaskResponseVariant2? taskResponseVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::WaveSpeedAI.TaskResponse(
                api,
        ...
        public override void Write(
            ...
            global::WaveSpeedAI.TaskResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
