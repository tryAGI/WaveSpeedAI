...
{
    /// <inheritdoc />
    public sealed class VideoGenerationRequestOutputFormatJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::WaveSpeedAI.VideoGenerationRequestOutputFormat>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::WaveSpeedAI.VideoGenerationRequestOutputFormatExtensions.ToValueString(value));
        }
    }
}
