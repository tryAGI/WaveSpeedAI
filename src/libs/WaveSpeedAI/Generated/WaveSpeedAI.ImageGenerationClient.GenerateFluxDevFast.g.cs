...
namespace WaveSpeedAI
{
    public partial class ImageGenerationClient
    {
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement s_GenerateFluxDevFastSecurityRequirement0 =
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement[] s_GenerateFluxDevFastSecurityRequirements =
            new global::WaveSpeedAI.EndPointSecurityRequirement[]
            {                s_GenerateFluxDevFastSecurityRequirement0,
            };
        partial void PrepareGenerateFluxDevFastArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::WaveSpeedAI.ImageGenerationRequest request);
        partial void PrepareGenerateFluxDevFastRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::WaveSpeedAI.ImageGenerationRequest request);
        partial void ProcessGenerateFluxDevFastResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateFluxDevFastResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate image with FLUX Dev Fast<br/>
        /// Generates an image using the accelerated FLUX Dev Fast model with WaveSpeed optimization for faster inference.
        /// </summary>
        /// <param name="request"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.TaskResponse> GenerateFluxDevFastAsync(

            global::WaveSpeedAI.ImageGenerationRequest request,
            global::WaveSpeedAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateFluxDevFastAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateFluxDevFastAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateFluxDevFastArguments(
            ...
            var __authorizations = global::WaveSpeedAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateFluxDevFastSecurityRequirements,
                operationName: "GenerateFluxDevFastAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::WaveSpeedAI.PathBuilder(
                                path: "/wavespeed-ai/flux-dev-fast",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateFluxDevFastRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::WaveSpeedAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateFluxDevFast",
                                methodName: "GenerateFluxDevFastAsync",
                                pathTemplate: "\"/wavespeed-ai/flux-dev-fast\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateFluxDevFastResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateFluxDevFastResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateFluxDevFastAsync(
                request: __request,
                requestOptions: requestOptions,
