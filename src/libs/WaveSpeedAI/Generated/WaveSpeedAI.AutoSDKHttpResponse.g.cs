...
namespace WaveSpeedAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::WaveSpeedAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::WaveSpeedAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::WaveSpeedAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::WaveSpeedAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::WaveSpeedAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::WaveSpeedAI.ApiException exception)
        ...
        private static global::WaveSpeedAI.AutoSDKRequestOptions CloneRequestOptions(
            global::WaveSpeedAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::WaveSpeedAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
