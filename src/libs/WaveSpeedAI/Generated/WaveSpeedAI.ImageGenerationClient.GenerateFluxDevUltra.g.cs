...
namespace WaveSpeedAI
{
    public partial class ImageGenerationClient
    {
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement s_GenerateFluxDevUltraSecurityRequirement0 =
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement[] s_GenerateFluxDevUltraSecurityRequirements =
            new global::WaveSpeedAI.EndPointSecurityRequirement[]
            {                s_GenerateFluxDevUltraSecurityRequirement0,
            };
        partial void PrepareGenerateFluxDevUltraArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::WaveSpeedAI.ImageGenerationRequest request);
        partial void PrepareGenerateFluxDevUltraRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::WaveSpeedAI.ImageGenerationRequest request);
        partial void ProcessGenerateFluxDevUltraResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateFluxDevUltraResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.TaskResponse> GenerateFluxDevUltraAsync(

            global::WaveSpeedAI.ImageGenerationRequest request,
            global::WaveSpeedAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GenerateFluxDevUltraAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateFluxDevUltraAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateFluxDevUltraArguments(
            ...
            var __authorizations = global::WaveSpeedAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateFluxDevUltraSecurityRequirements,
                operationName: "GenerateFluxDevUltraAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::WaveSpeedAI.PathBuilder(
                                path: "/wavespeed-ai/flux-dev-ultra",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateFluxDevUltraRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::WaveSpeedAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateFluxDevUltra",
                                methodName: "GenerateFluxDevUltraAsync",
                                pathTemplate: "\"/wavespeed-ai/flux-dev-ultra\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateFluxDevUltraResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateFluxDevUltraResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GenerateFluxDevUltraAsync(
                request: __request,
                requestOptions: requestOptions,
