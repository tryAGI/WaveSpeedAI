...
namespace WaveSpeedAI
{
    public partial class ImageGenerationClient
    {
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement s_GenerateFluxDevSecurityRequirement0 =
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement[] s_GenerateFluxDevSecurityRequirements =
            new global::WaveSpeedAI.EndPointSecurityRequirement[]
            {                s_GenerateFluxDevSecurityRequirement0,
            };
        ...
        {
            var __response = await GenerateFluxDevAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateFluxDevAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::WaveSpeedAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateFluxDevSecurityRequirements,
                operationName: "GenerateFluxDevAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::WaveSpeedAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GenerateFluxDevAsync",
                                pathTemplate: "\"/wavespeed-ai/flux-dev\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
