...
namespace WaveSpeedAI
{
    public partial class ImageGenerationClient
    {
        ...
        {
            var __response = await GenerateFluxSchnellAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateFluxSchnellAsResponseAsync(
