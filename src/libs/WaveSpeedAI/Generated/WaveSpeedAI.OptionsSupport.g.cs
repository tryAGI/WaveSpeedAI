...
namespace WaveSpeedAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::WaveSpeedAI.AutoSDKRetryOptions Retry { get; set; } = new global::WaveSpeedAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::WaveSpeedAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::WaveSpeedAI.IAutoSDKHook>();
        ...
        public global::WaveSpeedAI.AutoSDKClientOptions AddHook(
            global::WaveSpeedAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::WaveSpeedAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::WaveSpeedAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::WaveSpeedAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::WaveSpeedAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::WaveSpeedAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::WaveSpeedAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::WaveSpeedAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::WaveSpeedAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::WaveSpeedAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::WaveSpeedAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::WaveSpeedAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::WaveSpeedAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::WaveSpeedAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::WaveSpeedAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::WaveSpeedAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::WaveSpeedAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::WaveSpeedAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::WaveSpeedAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::WaveSpeedAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::WaveSpeedAI.AutoSDKClientOptions clientOptions,
            global::WaveSpeedAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::WaveSpeedAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::WaveSpeedAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::WaveSpeedAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::WaveSpeedAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::WaveSpeedAI.IAutoSDKHook, global::WaveSpeedAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::WaveSpeedAI.AutoSDKHookContext context)
        {
