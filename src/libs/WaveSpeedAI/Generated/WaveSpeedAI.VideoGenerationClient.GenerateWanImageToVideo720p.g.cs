...
namespace WaveSpeedAI
{
    public partial class VideoGenerationClient
    {
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement s_GenerateWanImageToVideo720pSecurityRequirement0 =
        ...
        private static readonly global::WaveSpeedAI.EndPointSecurityRequirement[] s_GenerateWanImageToVideo720pSecurityRequirements =
            new global::WaveSpeedAI.EndPointSecurityRequirement[]
            {                s_GenerateWanImageToVideo720pSecurityRequirement0,
            };
        ...
        {
            var __response = await GenerateWanImageToVideo720pAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::WaveSpeedAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::WaveSpeedAI.AutoSDKHttpResponse<global::WaveSpeedAI.TaskResponse>> GenerateWanImageToVideo720pAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::WaveSpeedAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateWanImageToVideo720pSecurityRequirements,
                operationName: "GenerateWanImageToVideo720pAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::WaveSpeedAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::WaveSpeedAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateWanImageToVideo720p",
                                methodName: "GenerateWanImageToVideo720pAsync",
                                pathTemplate: "\"/wavespeed-ai/wan-2.1/wan-2.1-i2v-720p\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
